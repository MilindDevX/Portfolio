 ...
 */
export type IANATimeZone = Extract<keyof typeof zones, string> | "Asia/India"; // Narrow to string keys for React usage
...
export interface Home extends BasePageConfig {
  ...
  /** The headline for the Data Analyst role */
  headlineData: React.ReactNode;
  ...
  /** Latest work badge, which can appear next to featured */
  latestWork?: {
    display: boolean;
    title: React.ReactNode;
    href: string;
  };
  /** Subline raw text for full stack */
  sublineText: React.ReactNode;
  /** Subline raw text for data analyst */
  sublineDataText: React.ReactNode;
}
...
export interface About extends BasePageConfig {
  ...
  intro: {
    ...
    description: React.ReactNode;
    /** Data analyst description of the introduction section */
  ...
  work: {
    ...
    /** List of work experiences for Data Analyst */
  ...
  technical: {
    ...
    /** List of technical skills for Data Analyst */
    skillsData: Array<{
      /** Skill title */
      title: string;
      /** Skill description */
